...
public class Main {
    ...
    // int vacancy = Cindex.getVacancyCindex(coursecode, cindex);//course details
    // should oso show vacancy

    // if(){ //how to check timetable clash?

    // System.out.println("Unable to add because of timetable clash!");
    // }
    // // else if(Course.getAU() > Student.getNumAuAvail() ||
    // Student.getNumAuAvail() == 0){
